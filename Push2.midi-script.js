...
PUSH2.init = function (id, debugging) {
  ...
  var createKillToggleCallback = function (control) {
    return function (value, group, controlName) {
      PUSH2.setToggleButtonLedState(
        ...
        PUSH2.COLORS.green,
        PUSH2.COLORS.red,
        PUSH2.ANIMATIONS.button.blinking
      );
    };
  };
  ...
  engine
    .makeConnection(
      groupLeft,
      "button_parameter1",
      createKillToggleCallback(PUSH2.DISPLAY_BUTTONS.button1)
    )
    .trigger();
  engine
    .makeConnection(
      groupLeft,
      "button_parameter2",
      createKillToggleCallback(PUSH2.DISPLAY_BUTTONS.button2)
    )
    .trigger();
  engine
    .makeConnection(
      groupLeft,
      "button_parameter3",
      createKillToggleCallback(PUSH2.DISPLAY_BUTTONS.button3)
    )
    .trigger();
  ...
  engine
    .makeConnection(
      groupRight,
      "button_parameter1",
      createKillToggleCallback(PUSH2.DISPLAY_BUTTONS.button6)
    )
    .trigger();
  engine
    .makeConnection(
      groupRight,
      "button_parameter2",
      createKillToggleCallback(PUSH2.DISPLAY_BUTTONS.button7)
    )
    .trigger();
  engine
    .makeConnection(
      groupRight,
      "button_parameter3",
      createKillToggleCallback(PUSH2.DISPLAY_BUTTONS.button8)
    )
    .trigger();

  engine
    .makeConnection("[Channel1]", "play", function (value, group, controlName) {
      PUSH2.setTogglePadLedState(
        value,
        group,
        controlName,
        PUSH2.PADS.pad57,
        PUSH2.COLORS.darkgreen,
        PUSH2.COLORS.green,
        PUSH2.ANIMATIONS.pad.blinking_slow
      );
    })
    .trigger();
  engine
...
PUSH2.setPadsFaderLeds = function (value, group, controlName) {
  ...
  if (value === 0) {
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.pad.static,
      PUSH2.PADS.pad60 + channelOffset,
      PUSH2.COLORS.black
    );
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.pad.static,
      PUSH2.PADS.pad52 + channelOffset,
      PUSH2.COLORS.black
    );
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.pad.static,
      PUSH2.PADS.pad44 + channelOffset,
      PUSH2.COLORS.black
    );
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.pad.static,
      PUSH2.PADS.pad36 + channelOffset,
      PUSH2.COLORS.black
    );
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.pad.static,
      PUSH2.PADS.pad28 + channelOffset,
      PUSH2.COLORS.black
    );
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.pad.static,
      PUSH2.PADS.pad20 + channelOffset,
      PUSH2.COLORS.black
    );
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.pad.static,
      PUSH2.PADS.pad12 + channelOffset,
      PUSH2.COLORS.black
    );
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.pad.static,
      PUSH2.PADS.pad4 + channelOffset,
      PUSH2.COLORS.black
    );
...
PUSH2.toggleMixxButton = function (
  controlName,
  channel,
  control,
  value,
...
PUSH2.setToggleButtonLedState = function (
  value,
  group,
  controlName,
  control,
  color,
  toggledColor,
  toggleAnimationChannel
) {
  if (value) {
    midi.sendShortMsg(
      toggleAnimationChannel || PUSH2.ANIMATIONS.button.static,
      control,
      toggledColor || PUSH2.COLORS.white
    );
  } else {
    midi.sendShortMsg(
      PUSH2.ANIMATIONS.button.static,
      control,
      color || PUSH2.COLORS.gray
    );
  }
};

PUSH2.setTogglePadLedState = function (
  value,
  group,
  controlName,
  control,
  ...
  if (value > 1) {
    midi.sendShortMsg(
      toggleAnimationChannel || PUSH2.ANIMATIONS.pad.static,
      control,
      toggledColor2 || PUSH2.COLORS.white
    );
  } else if (value > 0) {
    midi.sendShortMsg(
      toggleAnimationChannel || PUSH2.ANIMATIONS.pad.static,
